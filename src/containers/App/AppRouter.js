...
const routes = [
  {
    path: '',
    component: asyncComponent(() => import('../Users/List.js')),
  },
  {
    path: "users/list",
  ...
  {
    path: "customers/list",
    component: asyncComponent(() => import("../Customers/List"))
  },
  {
    path: "customers/addInfo",
    component: asyncComponent(() => import("../Customers/AddInfo"))
  },
  {
    path: "customers/edit/:tabId",
    component: asyncComponent(() => import("../Customers/Edit"))
  },
  // {
  //   path: "customers/addDriver",
  //   component: asyncComponent(() => import("../Customers/AddDriver"))
  // },
  // {
  //   path: "customers/addDoc",
  //   component: asyncComponent(() => import("../Customers/AddDoc"))
  // },
  // {
  //   path: "customers/addService",
  //   component: asyncComponent(() => import("../Customers/AddService"))
  // },
  // {
  //   path: "customers/addTruck",
  //   component: asyncComponent(() => import("../Customers/AddTruck"))
  // }, {
  //   path: "customers/editDriver",
  //   component: asyncComponent(() => import("../Customers/EditDriver"))
  // },
  // {
  //   path: "customers/editDoc",
  //   component: asyncComponent(() => import("../Customers/EditDoc"))
  // },
  // {
  //   path: "customers/editService",
  //   component: asyncComponent(() => import("../Customers/EditService"))
  // },
  // {
  //   path: "customers/editTruck",
  //   component: asyncComponent(() => import("../Customers/EditTruck"))
  // },
  {
    path: 'inbox',
